...
var options = {
    ...
    labels: ["A - White", "B - Red", "C - Blue", "D - Green", "E - Yellow"],
    xaxis: {
        type: "text"
    },
    yaxis: [{
...
barchartColors = getChartColorsArray("basic_pyramid_area"),
options = {
    series: [{
        name: "",
...
barchartColors = getChartColorsArray("basic_recruitment_area"),
options = {
    series: [{
        name: "Funnel Series",
