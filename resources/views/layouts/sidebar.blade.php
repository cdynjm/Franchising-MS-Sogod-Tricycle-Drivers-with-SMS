@php
    ...
    $newApplication = Franchise::where('status', 0)->orWhere('status', 1)->count();
    $renewal = Franchise::where('status', 3)->orWhere('status', 4)->count();
        ...
        <a href="javascript:;" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <h1 class="align-items-center d-flex mt-3" href="javascript:;">
                    <img style="width: 50px; height: 50px;" src="{{ asset('storage/logo/logo-sogod.gif') }}"
                        class="mb-4 mt-2" alt="...">
