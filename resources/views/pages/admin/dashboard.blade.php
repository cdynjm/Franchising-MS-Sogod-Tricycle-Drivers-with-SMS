                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between">
                                                        <div>
                                                            <h6 class="font-size-15">{{ $cat->category }} - {{ $cat->color }}</h6>
                                                            <h4 class="mt-1 pt-1 mb-0 font-size-22">{{ $cat->users_count }} <span class="text-success fw-medium font-size-14 align-middle"> <i class="mdi mdi-arrow-up"></i>Total </span> </h4>
                                                        </div>
                                                        <div class="">
                                                            <div class="avatar">
                                                                <div class="avatar-title rounded bg-primary-subtle ">
                                                                    <img src="{{ asset('storage/icons/tricycle.png') }}" height="30" alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card-body pb-0">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="card-title mb-4">Overview
                                                    <p class="d-lg-none d-md-none d-sm-block text-primary mt-2" style="font-size: 13px">Long Press the shades to display data</p>
                                                </h5>
                                            </div>
