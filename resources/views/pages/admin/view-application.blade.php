        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- view the franchise application -->
                        ...
                        <div class="col-md-12">
                            <div class="card mt-4 rounded-1">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <!-- this list of buttons corresponds the status of the application -->
                                    ...
                                    <div class="btn-group">
                                        @if ($application->status == 0)
                                            ...
                                            <button class="btn btn-sm btn-danger rounded-1 shadow-lg text-white"
                                                id="reject-application"><i class="fas fa-times me-1"></i> Revert</button>
                                        @endif
                                        @if ($application->status == 3)
                                            <button class="btn btn-sm btn-success rounded-1 shadow-lg text-white me-2"
                                                id="confirm-renewal"><i class="fas fa-check me-1"></i> Confirm</button>
                                            <button class="btn btn-sm btn-danger rounded-1 shadow-lg text-white"
                                                id="reject-renewal"><i class="fas fa-times me-1"></i> Revert</button>
                                        @endif
                                ...
                                <!-- list of information of the applicant -->
