        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- in this area, this is where the applicant renew their franchise if they choose to renew online rather than process it through walk-in -->
                                ...
                                <div class="wizard-tab">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    <input type="hidden" class="form-control" name="unitStatus" value="{{ $unit }}">
                                                    <div class="col-md-6">
                                ...
                                <div class="wizard-tab">
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <!-- list of requirements to be uploaded -->
