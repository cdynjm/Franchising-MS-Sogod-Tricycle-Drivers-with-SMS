                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <div>
                                            <div id="chart-radialBar" class="mb-4" data-colors='["#556ee6", "#34c38f", "#f46a6a"]'></div>
                                            ...
                                            <div class="text-center mt-4">
                                                ...
                                                @if($user->status == 2)
                                                    @if($user->isActive == 0)
                                                        <button href="javascript:;" class="btn btn-success btn-sm" id="renew-franchise">Renew Franchise</button>
                                                    @endif
                                                @endif
                                            </div>
                                        </div>
                                       ...
                                       <div class="mt-4 px-1 pt-1">
                                            <div class="table-responsive">
                                                <div class="text-center mb-4">
                                                    <button type="button" class="btn bg-warning text-dark fw-bold fs-2 btn-lg p-2 rounded-1 shadow-lg">{{ Auth::user()->categories->category }} - {{ sprintf('%03d', Auth::user()->name) }}</button>
                                                </div>
                                                <h6 class="ms-2 text-center">{{ $user->applicant }}</h6>
                                                <p class="fw-normal text-center">{{ ucwords(strtolower($user->address)) }}</p>
                                                <table class="table table-hover text-nowrap text-center" style="font-size: 13px;">
                                                    <thead>
                                                        <tr>
                                                            <th>UNIT</th>
                                                            <th>MOTOR NO.</th>
                                                ...
                                                <p class="fw-normal text-center" style="font-size: 13px;">
                                                    ...
                                                    <span class="text-success">{{ date('F d, Y', strtotime($user->created_at)) }}</span>
                                                </p>
                                                <p class="fw-normal text-center" style="font-size: 13px;">
                                                    <span class="text-muted">Expires on: </span> 
                                                    <span class="text-danger">{{ date('F d, Y', strtotime($user->expiresOn)) }}</span>
                                                </p>
                                                @endif
                                            </div>
                                       </div>
