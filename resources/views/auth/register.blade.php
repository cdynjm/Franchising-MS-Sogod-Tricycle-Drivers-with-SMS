            ...
            <div class="col-md-12">
                ...
                <div class="mb-4 pb-2">
                    <a href="index.html" class="d-block auth-logo">
                        <img src="{{ asset('storage/logo/logo.png') }}" alt="" height="70" class="auth-logo-dark me-start">
                        <img src="{{ asset('storage/logo/logo.png') }}" alt="" height="70" class="auth-logo-light me-start">
                    </a>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <p style="font-size: 13px;">
                                                    If your tricycle's body number is already registered in our system, please do not attempt to register it again. Duplicate registrations will not be accepted and may cause delays in your application process. Instead, please log in to your existing account to update your information or manage your franchise details. If you encounter any issues or need assistance, contact our support team for help.
                                                </p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="1" min="0" id="bodyNumber" class="form-control" name="bodyNumber">
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <select name="category" id="category" class="form-select">
                                                    ...
                                                    @foreach ($categories as $cat)
                                                        <option value="{{ $aes->encrypt($cat->id) }}">{{ $cat->category }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                    ...
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="username" style="font-size: 13px">Username</label>
                                                    <div class="position-relative input-custom-icon">
                                                        <input type="text" class="form-control fw-bolder text-primary" id="username" name="username" placeholder="Enter username" readonly>
                                                ...
                                                <div>
                                                    <small class="text-danger">Please take note of your credentials, as they will serve as your account for this BODY NUMBER to log in to the system for renewal purposes</small>
                                                </div>
                                            </div>
                ...
                <div class="mt-4 text-center">
                    <p class="mb-0">Already have an account? <a wire:navigate href="{{ route('login') }}" class="fw-medium text-primary"> Log in. </a> </p>
                </div>
            </div><!-- end col -->
        </div><!-- end row -->
