        ...
        @foreach ($franchise as $fr)
            <tr>
                ...
                <td class="text-center">
                    <span class="d-flex mt-2">
                        <a class="text-dark" wire:navigate href="{{ route('user.view-application', ['id' => $aes->encrypt($fr->id)]) }}?{{ \Str::random(20) }}" class="me-2">
                            {{ $fr->applicant }}
                        </a>
                    </span>
                </td>
                ...
                <td>
                    <span class="d-flex mt-2">
                        <a wire:navigate href="{{ route('user.view-application', ['id' => $aes->encrypt($fr->id)]) }}?{{ \Str::random(20) }}" class="me-2">
