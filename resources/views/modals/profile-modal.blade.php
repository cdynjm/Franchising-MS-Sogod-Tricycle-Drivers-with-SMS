<div class="modal fade" id="profile-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <form action="" id="update-profile">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        @if(Auth::user()->role == 2)
                            <p class="text-danger m-0 mb-2"><small>Name cannot be changed due to information security purposes</small></p>
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        @if(Auth::user()->role == 2)
                            <p class="text-danger m-0 mb-2"><small>Username cannot be changed due to information security purposes</small></p>
                        @endif
                        <div class="position-relative input-custom-icon">
