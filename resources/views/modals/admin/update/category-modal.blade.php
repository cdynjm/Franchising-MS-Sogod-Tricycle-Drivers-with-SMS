<div class="modal fade" id="update-category-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        ...
        <!-- this modal will update the category of tricycle -->
        ...
        <div class="modal-content">
            ...
            <form action="" id="update-category">
                <div class="modal-body">
                    ...
                    <label for="" style="font-size: 12px;">Change Sample Picture</label>
                    <input type="file" name="picture" id="update-sample-picture" accept=".jpg" class="form-control">
...
<script>
    document.addEventListener('livewire:navigated', () => { 
        ...
        const fileInputs = [
            document.querySelector('#update-sample-picture'),
        ];
